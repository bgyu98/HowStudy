                                ...
                                <form action="updateNote" method="post"  id="FormSelete">
                                    <div class="card shadow mb-4" style="width: 75%; margin: auto; margin-top: 50pt;">
                                        ...
                                        <div class="card-body" id="result" style="margin-left:15px;">
                                            <div class="inputTitle">
                                            <input type="text" id="gTitle" name="gTitle" style="width: 40%;" class="gTitle" placeholder="제목" value="${note.gTitle}"/>
                                        </div>
                                            <hr />
                                        <div>
                                            <textarea id="summernote2" name="gComment" class="gComment">${note.gComment}</textarea>
                                        </div>
                                        </div><br/><br/><br/>
