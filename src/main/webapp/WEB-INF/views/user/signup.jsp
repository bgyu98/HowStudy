                            ...
                            <div class="modal-body space-y-20 pd-40">
                              ...
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="취업"
                                /><span
                                  ><img src="../assets/images/likeTag/취업.png" />취업</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="독서"
                                /><span
                                  ><img src="../assets/images/likeTag/독서.png" />독서</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="어학"
                                /><span
                                  ><img src="../assets/images/likeTag/어학.png" />어학</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="임용"
                                /><span
                                  ><img src="../assets/images/likeTag/임용.png" />임용</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="공무원"
                                /><span
                                  ><img src="../assets/images/likeTag/공무원.png" />공무원</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="대학수능"
                                /><span
                                  ><img src="../assets/images/likeTag/대학수능.png" />대학수능</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="자격증"
                                /><span
                                  ><img src="../assets/images/likeTag/자격증.png" />자격증</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="학교공부"
                                /><span
                                  ><img src="../assets/images/likeTag/학교공부.png" />학교공부</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="기타"
                                /><span
                                  ><img src="../assets/images/likeTag/기타.png" />기타</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="코딩"
                                /><span
                                  ><img src="../assets/images/likeTag/코딩.png" />코딩</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="이직"
                                /><span
                                  ><img src="../assets/images/likeTag/이직.png" />이직</span
                                ></label
                              >
                              <label class="box-check-input"
                                ><input
                                  ...
                                  value="자기계발"
                                /><span
                                  ><img src="../assets/images/likeTag/자기계발.png" />자기계발</span
                                ></label
                              >
