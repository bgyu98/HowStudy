                    ...
                    <div id="site-logo" class="clearfix">
                      <div id="site-logo-inner">
                        <a href="index" rel="home" class="main-logo">
                          <img id="logo_header" src="../assets/images/logo/logo01.png" alt="nft-gaming" width="180"
                            height="80" data-retina="assets/images/logo/logo_dark@2x.png" data-width="133"
                            data-height="56" />
                        </a>
                      </div>
                    </div>
                      ...
                      <div class="header-search flat-show-search" id="s1">
                        <a href="#" class="show-search header-search-trigger">
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                            ...
                            <mask id="mask0_334_638" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="1" y="1"
                              width="18" height="17">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M1.66699 1.66666H17.6862V17.3322H1.66699V1.66666Z" fill="white" stroke="white" />
                            </mask>
                            ...
                            <mask id="mask1_334_638" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="13" y="13"
                              width="6" height="6">
                              <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M14.2012 14.2999H18.3333V18.3333H14.2012V14.2999Z" fill="white" stroke="white" />
                            </mask>
                  ...
                  <div class="form-inner">
                    <form method="post" id="modifyForm" action="modifyForm">
                      ...
                      <div class="modifyBtn" style="text-align: center; display: inline-block; width: 100%">
                        <a name="likeTags" href="#" data-toggle="modal" data-target="#popup_bid"><button type="button" style="width: 40%;">선호태그</button></a>
