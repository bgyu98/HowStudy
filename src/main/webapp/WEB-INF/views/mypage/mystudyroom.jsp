...
>>>>>>> main
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="slider-item"> <!-- item start -->
                                                        <div class="sc-card-collection style-2 home2"
                                                            ...
                                                            <button class="wishlist-button2 public heart mg-t-6 active"
                                                                id="wishlist-button2"><span
                                                                    class="number-like">${fr.sFavorNum}</span></button>

                                                            <div class="card-media" style="margin-top: 13px;">
                                                                <img src="../assets/images/box-item/image-box-32.jpg"
                                                                    alt="Image"
                                                                    style="width: 100%;  border-radius: 15px;">
                                                                <!--상세보기-->

                                                            </div>
                                                            <div class="card-bottom" style="margin-top: 7px;">
                                                                <div class="author">
                                                                    <div class="sc-author-box style-2">
                                                                        <div class="author-avatar">
                                                                    ...
                                                                    <div class="content">
                                                                        <h4><a>${fr.sTitle}</a></h4> <!-- 제목 -->
                                                                        <div class="infor" style="margin-top: 5px;">
                                                                            <span>CREATE BY</span>
                                                                            <span
                    ...
                    <!-- visited section start-->
                    <section class="tf-section live-auctions home5 style2 bg-style3" style="background-color: #fff;">
                        <div class="themesflat-container">
                            <!-- 날짜 선택 select 문-->
                            <div class="row">
                                <div class="col-md-12">
                                                    ...
                                                    <div class="slider-item">
                                                        <div class="sc-card-product menu_card style2"
                                                            ...
                                                            <div class="meta-info style2">
                                                                ...
                                                                <div class="fdate" style="font: 7px;">
                                                                    <span>Date</span>
                                                                    <h5> ${rR.sDate}</h5> <!-- 날짜-->
                                                                </div>
