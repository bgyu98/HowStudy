              ...
              <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="sc-card-product">
                  ...
                  <div class="card-title">
                    ...
                    <div class="tags">${searchStudyRoom.sNum}</div>
                    <div class="tags">${searchStudyRoom.sCategory}</div>
                  </div>

                  <div class="meta-info">
                    <div class="author">
                      <div class="info">
                        <h6><a href="author02.html">${searchStudyRoom.sComment}</a></h6>
                      </div>
                    </div>
                    <div class="price">
                      <span>총 인원수 : ${searchStudyRoom.sPeopleNum}</span>
                      <span>조회수 : ${cnt.sCnt}</span>
                    </div>
                  </div>
