                    ...
                    <div class="header-search flat-show-search" id="s1">
                      ...
                      <div class="top-search">
                        <form role="search" class="search-form" id="searchFrm">
                          <input type="text" id="s" class="search-field" placeholder="검색어를 입력하세요" name="items"
                            required="" />
                      ...
                      <div class="admin_active" id="header_admin">
                        <div class="header_avatar">
                          <div class="popup-user">
                            <img class="avatar" src="../assets/images/icon/usericon.png" alt="avatar" />
                            <div class="avatar_popup mt-20">
                              ...
                              <div class="links mt-20">
                                <a class="mt-10" href="../user/modifyAccount?mId=${sessionScope.loginId}">
